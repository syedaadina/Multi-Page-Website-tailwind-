...
function Contact() {
    ...
    return (
        <section id="contact" className="py-12 px-4 bg-gradient-to-r from-pink-600 to-pink-950">
            <h2 className="text-3xl font-extrabold text-center mb-6 font-serif text-white">Contact Us</h2>
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto bg-white shadow-md rounded-lg p-8">
                <div className="mb-4">
                    ...
                    <input
                        ...
                        className="text-black w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring focus:ring-yellow-600"
                    />
                </div>
                ...
                <button type="submit" className="w-full bg-yellow-600 text-white font-bold font-serif py-2 rounded-lg hover:bg-yellow-800 transition duration-300">
                    Send Message
                </button>
            </form>
        </section>
